...
// MCQ-Based Quiz: 10–15 questions with multiple-choice answers
const questions = [
...
const Quiz = ({ onSubmit }) => {
  ...
  const [timeLeft, setTimeLeft] = useState(15); // 10-seconds timer on every question
  //   Timer for Each Question: Auto-move to the next question after time expires.
